...
#pragma mark--
- (DKFontPicker)dk_setFontPicker {
    return objc_getAssociatedObject(self, @selector(dk_setFontPicker));
}
-(void)dk_setFontPicker:(DKFontPicker)fontPickers{
    objc_setAssociatedObject(self, _cmd, fontPickers, OBJC_ASSOCIATION_COPY_NONATOMIC);
    self.font = fontPickers(self.dk_fontManager.fontVersion);
    [self.fontPickers setValue:[fontPickers copy] forKey:@"setFont:"];
}
- (DKAttributedStringPicker)dk_setAttributedTextPicker{
        return objc_getAssociatedObject(self, @selector(dk_setAttributedTextPicker));
}
-(void)dk_setAttributedTextPicker:(DKAttributedStringPicker)dictionaryPickers{
    objc_setAssociatedObject(self, _cmd, dictionaryPickers, OBJC_ASSOCIATION_COPY_NONATOMIC);
    self.attributedText = dictionaryPickers(self.dk_fontManager.fontVersion);
    [self.fontPickers setValue:[dictionaryPickers copy] forKey:@"setAttributedText:"];
}
@end
