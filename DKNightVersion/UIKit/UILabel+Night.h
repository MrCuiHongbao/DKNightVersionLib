...
@property (nonatomic, copy, setter = dk_setFontPicker:) DKFontPicker dk_setFontPicker;
@property (nonatomic, copy, setter = dk_setAttributedTextPicker:) DKAttributedStringPicker dk_setAttributedTextPicker;
@end
